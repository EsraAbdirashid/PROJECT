  ...
  return (
    ...
    <div className="for bg-orange-600 h-screen text-center" data-aos="zoom-in-up">
        ...
        <form className='mt-16'>
          ...
          <input type="submit" placeholder='submit'className='border-4
                 text-white font-bold px-[100px] p-1 rounded-full outline-none hover:bg-white hover:text-orange-600 hover:border-2 mt-16' />        
        </form>
    </div>
    </>
  )
